...
@pytest.mark.usefixtures("amazon_data_setup")
class TestAmazonData:
    def test_best_sellers_data(self):
    ...
    def test_new_releases_data(self):
        Objects.object["home"].goto_amazon_home_page()
    ...
    def test_movers_and_shakers_data(self):
        Objects.object["home"].goto_amazon_home_page()
    ...
    def test_all_mobile_phones_data(self):
        Objects.object["home"].goto_amazon_home_page()
